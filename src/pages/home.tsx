/**
* Home Page
* UPDATED: Maps userHasLiked from API response to PostCard.
*/
...
export default function Home() {
  ...
  const fetchPosts = async (currentOffset: number) => {
    try {
      ...
      const nonAnonymousPosts = result.posts.filter((post) => !post.anon);
      
      setPosts((prev) => {
        const newPosts = nonAnonymousPosts.filter(
